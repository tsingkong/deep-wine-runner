    ...
    def ShowWindow():
        ...
        try:
            ...
            def Choose(choices):
                global choose
                choose = choices
            choosemsg.addButton("取消", QtWidgets.QMessageBox.ButtonRole.ActionRole).clicked.connect(lambda: Choose(0))
            choosemsg.addButton("提交评分", QtWidgets.QMessageBox.ButtonRole.ActionRole).clicked.connect(lambda: Choose(1))
            choosemsg.addButton("预测评分（不准确）", QtWidgets.QMessageBox.ButtonRole.ActionRole).clicked.connect(lambda: Choose(2))
            choosemsg.exec()
...
installBox86Own = QtGui.QAction(QtGui.QIcon.fromTheme("box"), QtCore.QCoreApplication.translate("U", "安装 Box86/Box64（使用自建源，支持 riscv64）"))
installLat = QtGui.QAction(QtCore.QCoreApplication.translate("U", "安装 lat（只限 Loongarch64 架构）"))
addWineDebMirrorForDeepin20 = QtGui.QAction(QtGui.QIcon(f"{programPath}/Icon/Function/wine.png"), QtCore.QCoreApplication.translate("U", "添加 Wine 运行器源以安装较新版本的 WineHQ（支持 Deepin20/Debian10）"))
p2 = QtGui.QAction(QtGui.QIcon.fromTheme("settings"), QtCore.QCoreApplication.translate("U", "设置程序(&S)"))
...
p3 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogDiscardButton), QtCore.QCoreApplication.translate("U", "清空软件历史记录(&C)"))
cleanCache = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogDiscardButton), QtCore.QCoreApplication.translate("U", "清空软件缓存"))
cleanProgramUnuse = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogDiscardButton), QtCore.QCoreApplication.translate("U", "删除程序组件"))
...
w1 = QtGui.QAction(QtCore.QCoreApplication.translate("U", "打开 Wine 容器目录"))
w2 = QtGui.QAction(QtGui.QIcon.fromTheme("font"), QtCore.QCoreApplication.translate("U", "安装常见字体"))
w3 = QtGui.QAction(QtGui.QIcon.fromTheme("font"), QtCore.QCoreApplication.translate("U", "安装自定义字体"))
w4 = QtGui.QAction(QtCore.QCoreApplication.translate("U", "删除选择的 Wine 容器"))
cleanBottonUOS = QtGui.QAction(QtCore.QCoreApplication.translate("U", "清理 Wine 容器（基于 Wine 适配活动脚本）"))
wineKeyboardLnk = QtGui.QAction(QtCore.QCoreApplication.translate("U", "Wine 快捷键映射"))
w5 = QtGui.QAction(QtGui.QIcon.fromTheme("deb"), QtCore.QCoreApplication.translate("U", "打包 wine 应用（专业用户使用）"))
w6 = QtGui.QAction(QtGui.QIcon.fromTheme("deb"), QtCore.QCoreApplication.translate("U", "使用官方 Wine 适配活动的脚本进行打包"))
easyPackager = QtGui.QAction(QtGui.QIcon.fromTheme("deb"), QtCore.QCoreApplication.translate("U", "使用简易打包器进行打包（小白且无特殊需求建议使用这个）"))
...
wm2_1 = QtGui.QAction(QtGui.QIcon.fromTheme("control-center2"), QtCore.QCoreApplication.translate("U", "打开指定wine、指定容器的控制面板"))
...
wm2_4 = QtGui.QAction(QtCore.QCoreApplication.translate("U", "打开指定wine、指定容器的任务管理器"))
wm2_5 = QtGui.QAction(QtCore.QCoreApplication.translate("U", "打开指定wine、指定容器的资源管理器"))
...
w8 = QtGui.QAction(QtCore.QCoreApplication.translate("U", "设置 run_v3.sh 的文管为 Deepin 默认文管"))
w9 = QtGui.QAction(QtCore.QCoreApplication.translate("U", "设置 run_v3.sh 的文管为 Wine 默认文管"))
w10 = QtGui.QAction(QtCore.QCoreApplication.translate("U", "重新安装 deepin-wine-helper"))
w11 = QtGui.QAction(QtGui.QIcon.fromTheme("winetricks"), QtCore.QCoreApplication.translate("U", "使用winetricks打开指定容器"))
w11WithWineLib = QtGui.QAction(QtGui.QIcon.fromTheme("winetricks"), QtCore.QCoreApplication.translate("U", "使用winetricks打开指定容器（使用Wine运行器运行库）"))
...
wm3_1 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogApplyButton), QtCore.QCoreApplication.translate("U", "开启 opengl"))
wm3_2 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogCancelButton), QtCore.QCoreApplication.translate("U", "禁用 opengl"))
ed1.addAction(wm3_1)
ed1.addAction(wm3_2)
ed2 = wm3.addMenu(QtCore.QCoreApplication.translate("U", "安装/卸载 winbind"))
wm4_1 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogApplyButton), QtCore.QCoreApplication.translate("U", "安装 winbind"))
wm4_2 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogCancelButton), QtCore.QCoreApplication.translate("U", "卸载 winbind"))
ed2.addAction(wm4_1)
ed2.addAction(wm4_2)
dxvkMenu = wm3.addMenu(QtCore.QCoreApplication.translate("U", "安装/卸载 DXVK"))
installDxvk = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogApplyButton), QtCore.QCoreApplication.translate("U", "安装 DXVK"))
uninstallDxvk = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogCancelButton), QtCore.QCoreApplication.translate("U", "卸载 DXVK"))
...
installvkd3d = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogApplyButton), QtCore.QCoreApplication.translate("U", "安装 Vkd3d"))
uninstallvkd3d = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogCancelButton), QtCore.QCoreApplication.translate("U", "卸载 Vkd3d"))
...
enabledWineBottleCreateLink = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogApplyButton), QtCore.QCoreApplication.translate("U", "允许指定 wine 容器生成快捷方式"))
disbledWineBottleCreateLink = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogCancelButton), QtCore.QCoreApplication.translate("U", "禁止指定 wine 容器生成快捷方式"))
...
disbledWineCrashDialog = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogCancelButton), QtCore.QCoreApplication.translate("U", "禁用指定 wine 容器崩溃提示窗口"))
enabledWineCrashDialog = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogApplyButton), QtCore.QCoreApplication.translate("U", "启用指定 wine 容器崩溃提示窗口"))
...
enabledOpenProgram = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogApplyButton), QtCore.QCoreApplication.translate("U", "允许指定 wine 容器创建文件关联"))
disbledOpenProgram = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogCancelButton), QtCore.QCoreApplication.translate("U", "禁止指定 wine 容器创建文件关联"))
...
enabledHttpProxy = QtGui.QAction(QtCore.QCoreApplication.translate("U", "设置指定 wine 容器的代理"))
disbledHttpProxy = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DialogCancelButton), QtCore.QCoreApplication.translate("U", "禁用指定 wine 容器的代理"))
...
editDllOver = QtGui.QAction(QtCore.QCoreApplication.translate("U", "编辑函数顶替库列表"))
...
v1 = QtGui.QAction(QtGui.QIcon.fromTheme("virtualbox"), QtCore.QCoreApplication.translate("U", "使用虚拟机运行 Windows 应用"))
...
s1 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_MessageBoxInformation), QtCore.QCoreApplication.translate("U", "360 沙箱云"))
s2 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_MessageBoxInformation), QtCore.QCoreApplication.translate("U", "微步云沙箱"))
s3 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_MessageBoxInformation), QtCore.QCoreApplication.translate("U", "VIRUSTOTAL"))
s4 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_MessageBoxInformation), QtCore.QCoreApplication.translate("U", "计算机病毒防御技术国家工程实验室"))
...
howtouseQemuUser = QtGui.QAction(QtCore.QCoreApplication.translate("U", "Qemu User 使用教程（配合运行库实现在非 X86 架构运行 X86 Wine）"))
...
videoHelpAction = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DriveNetIcon), QtCore.QCoreApplication.translate("U", "视频教程（Bilibili）"))
...
programInformation = QtGui.QAction(QtCore.QCoreApplication.translate("U", "获取程序公告（也可以在这里看程序安装/打开量）"))
h6 = QtGui.QAction(QtCore.QCoreApplication.translate("U", "反馈这个程序的建议和问题"))
fenUpload = QtGui.QAction(QtCore.QCoreApplication.translate("U", "程序评分"))
h7 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_MessageBoxInformation), QtCore.QCoreApplication.translate("U", "关于这个程序"))
h8 = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_MessageBoxInformation), QtCore.QCoreApplication.translate("U", "关于 Qt"))
...
gitee = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DriveNetIcon), QtCore.QCoreApplication.translate("U", "Gitee"))
github = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DriveNetIcon), QtCore.QCoreApplication.translate("U", "Github"))
gitlab = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DriveNetIcon), QtCore.QCoreApplication.translate("U", "Gitlab"))
jihu = QtGui.QAction(QtWidgets.QApplication.style().standardIcon(QtWidgets.QStyle.StandardPixmap.SP_DriveNetIcon), QtCore.QCoreApplication.translate("U", "Sourceforge"))
